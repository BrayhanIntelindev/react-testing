    ...
    <div className={styles.OrdersSummary}>
      ...
      <div className={styles.OrdersSummary__grid}>
        <div className={styles.OrdersSummary__item}>
          ...
          <p className={styles.OrdersSummary__value} data-testid="total-orders">{summary.totalOrders}</p>
        </div>
        <div className={styles.OrdersSummary__item}>
        ...
        <div className={styles.OrdersSummary__item}>
          ...
          <p className={styles.OrdersSummary__value} data-testid="average-order-value">
